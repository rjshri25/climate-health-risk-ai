...
BASE_PATH = r"C:\Disease Prediction Backend\models"

model_cat = joblib.load(BASE_PATH + r"\category_model.pkl")
features_cat = joblib.load(BASE_PATH + r"\features.pkl")

model_dis = joblib.load(BASE_PATH + r"\disease_model_final.pkl")
features_dis = joblib.load(BASE_PATH + r"\features_disease.pkl")

category_map = joblib.load(BASE_PATH + r"\category_map.pkl")
category_disease_map = joblib.load(BASE_PATH + r"\category_disease_map.pkl")
